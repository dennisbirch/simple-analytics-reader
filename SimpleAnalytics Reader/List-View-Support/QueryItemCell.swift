...
struct LocalizedQueryString {
    ...
    static let beforeOrEqual = NSLocalizedString("date-compare-before-equal", comment: "Date comparison option for 'On or before'")
    ...
    static let afterEquals = NSLocalizedString("date-compare-after-equals", comment: "Date comparison option for 'On or after'")
